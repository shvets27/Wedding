    ...
    <div class="about-content">
      ...
      <div class="about-text">
        ...
        <p class="about-paragraph">
          Иногда самые важные пути пересекаются там, где их совсем не ждешь. Наша история началась не под залпы салюта, а в тихой гармонии случайной встречи. Мы познакомились на общем дружеским пикнике.
        </p>
        <p class="about-paragraph">
          Тогда мы еще не знали, что этот миг станет первой страницей нашей большой книги. Все начиналось с легкого общения, долгих разговоров о чем угодно и ни о чем, с искренних улыбок и ощущения, что тебя понимают без слов. Дружба постепенно, как первый солнечный луч на рассвете, переросла во что-то большее — в трепетное и волнующее чувство, которое мы оба боялись и ждали одновременно.
        </p>
        <p class="about-paragraph">
