...
const dressCodePhotos = ref([
  ...
  { 
    type: 'text', 
    text: 'Мы с трепетом подбирали цветовую гамму свадьбы, но ещё больше мы хотим, чтобы вы были расслаблены и счастливы в этот день.\n\nЕсли вы чувствуете, что нежно-розовый — не ваш цвет, не переживайте! Смотрите следующие фотографии: мы подобрали несколько других оттенков, которые будут смотреться гармонично и уместно. Выбирайте тот, в котором чувствуете себя собой!'
  },
